...
:SetupOpenSSL
	ECHO SetupOpenSSL
	CALL :DownloadAndBuild32Bit
	REM CALL :DownloadAndBuild64Bit
...
REM only works with "VS2015 x86 Native Tools Command Prompt"
...
REM only works with "VS2015 x64 Native Tools Command Prompt"
